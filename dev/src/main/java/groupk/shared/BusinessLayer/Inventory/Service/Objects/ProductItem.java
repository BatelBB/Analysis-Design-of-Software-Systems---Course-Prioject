...
public class ProductItem {
    ...
    public ProductItem(groupk.shared.BusinessLayer.Inventory.ProductItem PItem) {
        id = PItem.getId();
        ...
        List<groupk.shared.BusinessLayer.Inventory.DiscountPair> BusinessCus_discount = PItem.getCus_discount();
        for (groupk.shared.BusinessLayer.Inventory.DiscountPair dp : BusinessCus_discount) {
