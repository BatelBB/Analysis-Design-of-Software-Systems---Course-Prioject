...
public class Product {
    ...
    public Product(groupk.shared.BusinessLayer.Inventory.Product p) {
        ...
        Map<Integer, groupk.shared.BusinessLayer.Inventory.ProductItem> BusinessItemsMap = p.getItems();
        items = new HashMap<>();
        for (Map.Entry<Integer, groupk.shared.BusinessLayer.Inventory.ProductItem> entry : BusinessItemsMap.entrySet()) {
