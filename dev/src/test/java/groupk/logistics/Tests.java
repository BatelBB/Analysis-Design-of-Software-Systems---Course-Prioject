...
public class Tests {
    ...
    public void updateVehicle() throws Exception {
        ...
        setDetails();
        try {
            truckManagerController.updateVehicleOnTrucking(319034121,1,"12315678");
        }
        catch (Exception e) {
    ...
    public void setWeight() throws Exception {
        ...
        setDetails();
        try {
            driverController.setWeightForTrucking(1,9);
        }
        catch (Exception e) {
            assertEquals(e.getMessage(),"There is a user already connected to the system");
        }
    ...
    public void addProducts() throws Exception {
        ...
        setDetails();
        try {
            truckManagerController.addProductToTrucking(1,"Eggs_4902505139314",2);
        }
        catch (Exception e) {
...
//
    ...
    public void removeProducts() throws Exception {
        ...
        setDetails();
            try {
                truckManagerController.moveProductsToTrucking(1,"Eggs_4902505139314",1);
            }
            catch (Exception e) {
                assertEquals(e.getMessage(),"There is a user already connected to the system");
            }
...
//
    ...
    public void removeTrucking() throws Exception {
        ...
        setDetails();
        try {
            truckManagerController.removeTrucking(1);
        }
        catch (Exception e) {
            assertEquals(e.getMessage(),"There is a user already connected to the system");
        }
