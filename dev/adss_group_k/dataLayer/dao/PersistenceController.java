...
public class PersistenceController {
    ...
    public CategoryDAO getCategories() {return categories;}
    public SubcategoryDAO getSubcategories() {return subcategories;}
    public SupplierDAO getSuppliers() {return suppliers;}
